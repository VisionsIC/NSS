...
cat /media/sf_sandbox/logs/access_log.log |awk '{print $1}' |sort > ip_sort01.txt ;cat /media/sf_sandbox/logs/ip_sort01.txt |awk '!x[$0]++' > ip_sort02.txt && cat ip_sort02.txt | xargs -I% curl http://ipinfo.io/%/region > ip_regions_final.txt
